...
const short CRC_16::m_CRC_16_lookuptable [256]= {
...
void CRC_16::next_databyte(char databyte) {
  m_remainder=short(((m_remainder<<8)^(m_CRC_16_lookuptable[((m_remainder>>8)&0xff)^databyte]))&0xffff);
}

//Public method for returning 16 bit CRC and reseting CRC_16 to ready state
short CRC_16::returnCRC_reset() {
  short rem = m_remainder;
  reset();
  return rem;
}
